...
function JobCard({ job, activeJob }: JobProps) {
  ...
  const companyDescription =
    "Lorem ipsum dolor, sit amet consectetur adipisicing elit. Modi, inventore! Facilis dolores maxime blanditiis aliquid eum quam, aperiam porro soluta veritatis magni praesentium saepe et rem impedit dolorem quasi ab.";
  ...
  return (
    <div
      ...
      <div className="flex justify-between">
        ...
        <button
          className={`text-2x ${isLiked ? "text-[#7263f3]" : "text-gray-400"}`}
          onClick={() => {
            isAuthenticated
              ? handleLike(job._id)
